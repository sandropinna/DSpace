...
<xsl:stylesheet
	...
	<xsl:template name="itemSummaryView-DIM-fields-Articolo">
      ...
      <xsl:choose>  
          ...
          <xsl:when test="$clause = 6 and (dim:field[@element='description' and @qualifier='status'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 9 and (dim:field[@element='relation' and @qualifier='ispartof'])">
           ...
           <!-- identifier.issn row -->
          <xsl:when test="$clause = 10 and (dim:field[@element='identifier' and @qualifier='issn'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 11 and (dim:field[@element='identifier' and @qualifier='eissn'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 13 and (dim:field[@element='relation' and @qualifier='ispartofseries'])">
                    <div class="simple-item-view-other">
          ...
          <!-- page number row -->
          <xsl:when test="$clause = 14 and (dim:field[@element='description' and @qualifier='pagenumber'])">
                    <div class="simple-item-view-other">
	...
	<xsl:template name="itemSummaryView-DIM-fields-Contributo-a-convegno">
      ...
      <xsl:choose>
          ...
          <!-- contributor row -->
          <xsl:when test="$clause = 6 and (dim:field[@element='contributor' and not(@qualifier)])">
                    <div class="simple-item-view-other">
	                	<span class="bold">Istituzioni partner:</span>
	                	<span>
	                		<xsl:for-each select="dim:field[@element='contributor' and not(@qualifier)]">
          ...
          <xsl:when test="$clause = 9 and (dim:field[@element='description' and @qualifier='conferencetitle'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 10 and (dim:field[@element='description' and @qualifier='conferencelocation'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 11 and (dim:field[@element='description' and @qualifier='conferencedate'])">
                    <div class="simple-item-view-other">
          ...
          <!-- identifier.citation row -->
          <xsl:when test="$clause = 13 and (dim:field[@element='identifier' and @qualifier='citation'])">
                    <div class="simple-item-view-other">
	                	<span class="bold">Citazione:</span>
	                	<span>
	                		<xsl:value-of select="dim:field[@element='identifier' and @qualifier='citation'][1]/node()"/>
         ...
         <!-- subject.progetti row  -->
          ...
          <!-- date.issued row -->
          <xsl:when test="$clause = 18 and (dim:field[@element='date' and @qualifier='issued'])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-date</i18n:text>:</span>
	                <span>
		                <xsl:for-each select="dim:field[@element='date' and @qualifier='issued']">
          ...
          <xsl:when test="$clause = 21 and (dim:field[@element='date'][@qualifier='embargoend'])">
  				<div class="simple-item-view-other">
    				<h4>
      					<xsl:value-of select="dim:field[@element='embargo'][@qualifier='description'][1]/node()"/>
     					<br />
	...
	<xsl:template name="itemSummaryView-DIM-fields-Scheda-progetto">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 9 and (dim:field[@element='description' and @qualifier='finanziamenti'])">
                    <div class="simple-item-view-other">
          ...
          <!-- contributor.responsabilescientifico row -->
          <xsl:when test="$clause = 11 and (dim:field[@element='contributor' and @qualifier='responsabilescientifico'])">
                    <div class="simple-item-view-other">
	                	<span class="bold">Responsabile Scientifico:</span>
	                	<span>	                		
		                    <xsl:for-each select="dim:field[@element='contributor' and @qualifier='responsabilescientifico']">
		                    <xsl:copy-of select="./node()"/>
		                      <xsl:if test="count(following-sibling::dim:field[@element='contributor' and @qualifier='responsabilescientifico']) != 0">
		                      	<xsl:text>; </xsl:text>
		                    	<br/>
		                    </xsl:if>
	                    	</xsl:for-each>		                    		                                       
	...
	<xsl:template name="itemSummaryView-DIM-fields-Tesi">
      ...
      <xsl:choose>
          ...
          <!-- description.status row -->
          <xsl:when test="$clause = 8 and (dim:field[@element='description' and @qualifier='status'])">
                    <div class="simple-item-view-other">
	...
	<xsl:template name="itemSummaryView-DIM-fields-Working-paper">
      ...
      <xsl:choose>
          ...
          <!-- identifier.doi row -->
          <xsl:when test="$clause = 10 and (dim:field[@element='identifier' and @qualifier='doi'])">
                    <div class="simple-item-view-other">
	                <span class="bold">DOI:</span>
	                <span>
	                	<xsl:for-each select="dim:field[@element='identifier' and @qualifier='doi']">
	...
	<xsl:template name="itemSummaryView-DIM-fields-Altro">
      ...
      <xsl:choose>
          ...
          <!-- Author(s) row -->
          <xsl:when test="$clause = 4 and (dim:field[@element='contributor'][@qualifier='author'] or dim:field[@element='contributor'][@qualifier='other'] or dim:field[@element='creator'] )">
                    <div class="simple-item-view-authors">
	                    <xsl:choose>
	                        <xsl:when test="dim:field[@element='contributor'][@qualifier='author']">
	                            <xsl:for-each select="dim:field[@element='contributor'][@qualifier='author']">
