...
<xsl:stylesheet
	...
	<xsl:template name="itemSummaryView-DIM-fields-Report">
      ...
      <xsl:choose>
          ...
          <!-- subject.program row  Unità organizzativa-->
          <xsl:when test="$clause = 2 and (dim:field[@element='subject' and @qualifier='program'])">
                    <div class="simple-item-view-other">
	                <span class="bold">Unità organizzativa:</span>
	                <span>
	                	<xsl:for-each select="dim:field[@element='subject' and @qualifier='program']">
          ...
          <!-- title.alternative row -->
          <xsl:when test="$clause = 4 and (dim:field[@element='title' and @qualifier='alternative'])">
                    <div class="simple-item-view-other">
	                <span>
	                  <h1>
	                	<xsl:for-each select="dim:field[@element='title' and @qualifier='alternative']">
          ...
          <!-- Author(s) row -->
          <xsl:when test="$clause = 5 and (dim:field[@element='contributor'][@qualifier='author'] or dim:field[@element='creator'] )">
                    <div class="simple-item-view-authors">
	                    <xsl:choose>
	                        <xsl:when test="dim:field[@element='contributor'][@qualifier='author']">
	                            <xsl:for-each select="dim:field[@element='contributor'][@qualifier='author']">
	...
	<xsl:template name="itemSummaryView-DIM-fields-Contributo-a-convegno">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 7 and (dim:field[@element='description' and @qualifier='conferencetitle'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 8 and (dim:field[@element='description' and @qualifier='conferencelocation'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 9 and (dim:field[@element='description' and @qualifier='conferencedate'])">
                    <div class="simple-item-view-other">
          ...
          <!-- identifier.citation row -->
          <xsl:when test="$clause = 11 and (dim:field[@element='identifier' and @qualifier='citation'])">
                    <div class="simple-item-view-other">
	                	<span class="bold">Citazione:</span>
	                	<span>
	                		<xsl:value-of select="dim:field[@element='identifier' and @qualifier='citation'][1]/node()"/>
	...
	<xsl:template name="itemSummaryView-DIM-fields-Brevetto">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 5 and (dim:field[@element='contributor' and @qualifier='inventorperson'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 6 and (dim:field[@element='contributor' and @qualifier='inventororganisation'])">
                    <div class="simple-item-view-other">
	                	<span class="bold">Inventore:</span>
	                	<span>
          ...
          <xsl:when test="$clause = 7 and (dim:field[@element='contributor' and @qualifier='author'])">
                    <div class="simple-item-view-other">
          ...
          <!-- contributor.other row -->
          <xsl:when test="$clause = 8 and (dim:field[@element='contributor' and @qualifier='other'])">
                    <div class="simple-item-view-other">
	                	<span class="bold">Titolare:</span>
	                	<span>
	                		<xsl:value-of select="dim:field[@element='contributor' and @qualifier='other'][1]/node()"/>
