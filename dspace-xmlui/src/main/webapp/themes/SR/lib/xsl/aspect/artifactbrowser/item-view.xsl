...
<xsl:stylesheet
	...
	<xsl:template name="itemSummaryView-DIM-fields-Articolo">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 6 and (dim:field[@element='relation' and @qualifier='ispartof'])">
                    <div class="simple-item-view-other">
           ...
           <!-- identifier.issn row -->
          <xsl:when test="$clause = 7 and (dim:field[@element='identifier' and @qualifier='issn'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 8 and (dim:field[@element='identifier' and @qualifier='eissn'])">
                    <div class="simple-item-view-other">
          ...
          <!-- page number row -->
          <xsl:when test="$clause = 11 and (dim:field[@element='description' and @qualifier='pagenumber'])">
                    <div class="simple-item-view-other">
	...
	<xsl:template name="itemSummaryView-DIM-fields-Atti-di-convegno">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 5 and (dim:field[@element='description' and @qualifier='abstract' and descendant::text()])">
           ...
           <!-- publisher row -->
          <xsl:when test="$clause = 6 and (dim:field[@element='publisher'])">
                    <div class="simple-item-view-other">
	                	<span class="bold">Editore:</span>
	                	<span>
	                		<xsl:value-of select="dim:field[@element='publisher'][1]/node()"/>
          ...
          <!-- numeropagine row -->
          <xsl:when test="$clause = 7 and (dim:field[@element='description' and @qualifier='numeropagine'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 9 and (dim:field[@element='relation' and @qualifier='ispartofseries'])">
           ...
           <!-- identifier.isbn row -->
          <xsl:when test="$clause = 10 and (dim:field[@element='identifier' and @qualifier='isbn'])">
                    <div class="simple-item-view-other">
	...
	<xsl:template name="itemSummaryView-DIM-fields-Contributo-a-convegno">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 6 and (dim:field[@element='description' and @qualifier='conferencetitle'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 7 and (dim:field[@element='description' and @qualifier='conferencelocation'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 8 and (dim:field[@element='description' and @qualifier='conferencedate'])">
                    <div class="simple-item-view-other">
	...
	<xsl:template name="itemSummaryView-DIM-fields-Scheda-progetto-CRS4">
      ...
      <xsl:choose>
          ...
          <!-- Contributo row -->
          <xsl:when test="$clause = 8 and (dim:field[@element='description' and @qualifier='contributionbudget'])">
                    <div class="simple-item-view-other">
          ...
          <!-- Contributo CRS4 row -->
          <xsl:when test="$clause = 9 and (dim:field[@element='description' and @qualifier='contributionbudgetCRS4'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 10 and (dim:field[@element='contributor' and @qualifier='other'])">
           ...
           <!-- subject.program row -->
          <xsl:when test="$clause = 11 and (dim:field[@element='subject' and @qualifier='program'])">
                    <div class="simple-item-view-other">
         ...
         <!-- subject.progetti row  -->
          ...
          <xsl:when test="$clause = 16 and (dim:field[@element='identifier' and @qualifier='websiteproject'])">
                    <div class="simple-item-view-other">
	...
	<xsl:template name="itemSummaryView-DIM-fields-Working-paper">
      ...
      <xsl:choose>
          ...
          <!-- identifier.doi row -->
          <xsl:when test="$clause = 8 and (dim:field[@element='identifier' and @qualifier='doi'])">
                    <div class="simple-item-view-other">
	                <span class="bold">DOI:</span>
	                <span>
	                	<xsl:for-each select="dim:field[@element='identifier' and @qualifier='doi']">
	...
	<xsl:template name="itemSummaryView-DIM-fields-Brevetto">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 11 and (dim:field[@element='identifier' and @qualifier='patentnumber'])">
                    <div class="simple-item-view-other">
