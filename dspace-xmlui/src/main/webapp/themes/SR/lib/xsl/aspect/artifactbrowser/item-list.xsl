				...
				<xsl:when test="dim:field[@element='type' and descendant::text()]">					
					<xsl:choose>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Immagine'">							
							<img src="/themes/SR/images/icons/Immagine.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Video'">							
							<img src="/themes/SR/images/icons/Video.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Articolo'">							
							<img src="/themes/SR/images/icons/Articolo.png" />
						</xsl:when>
						...
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Contributo a convegno'">							
							<img src="/themes/SR/images/icons/ContributoAConvegno.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Libro'">							
							<img src="/themes/SR/images/icons/Libro.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Contributo in un libro'">							
							<img src="/themes/SR/images/icons/ContributoInUnLibro.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Manuale'">							
							<img src="/themes/SR/images/icons/Manuale.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Catalogo'">							
							<img src="/themes/SR/images/icons/Catalogo.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Report'">							
							<img src="/themes/SR/images/icons/Report.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Scheda progetto'">							
							<img src="/themes/SR/images/icons/SchedaProgetto.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Tesi'">							
							<img src="/themes/SR/images/icons/Tesi.png" />
						</xsl:when>
						<xsl:when test="dim:field[@element='type'][1]/node() = 'Working paper'">							
							<img src="/themes/SR/images/icons/WorkingPaper.png" />
						</xsl:when>
						<xsl:otherwise>
							<img src="/themes/SR/images/icons/Altro.png" />
						</xsl:otherwise>
					</xsl:choose>
				</xsl:when>
				<xsl:otherwise>
